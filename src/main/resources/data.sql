...
insert into PATIENT (ID, PATIENT_NAME, GENDER, PHONE_NO)
values (1, 'Gabriel Riquelme', 'M',
        '0488001265');

insert into PATIENT (ID, PATIENT_NAME, GENDER,  PHONE_NO)
values (2, 'Pedro Ancelotti', 'M',
        '04880012616');

insert into PATIENT (ID, PATIENT_NAME, GENDER, PHONE_NO)
values (3, 'Iker Casillas', 'M',
        '04885151265');

insert into PATIENT (ID, PATIENT_NAME, GENDER,  PHONE_NO)
values (4, 'Cristiano Ronaldo', 'M',
        '04880511265');

insert into PATIENT (ID, PATIENT_NAME, GENDER,  PHONE_NO)
values (5, 'Monica Pelluci', 'F',
        '0488511265');
